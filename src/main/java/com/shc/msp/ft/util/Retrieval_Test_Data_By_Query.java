...
public class Retrieval_Test_Data_By_Query {
	...
	public static String VDC_orderId=null;
	...
	public static String VDC_lineitem_SKU= null;
	...
	public void Line_Item_Return_Item_Data() throws Exception{
		...
		Sql_LineItem_Return_Item_Eligible = "SELECT o.SITE_GEN_ORD_ID,oi.item_id FROM ORD O,ORD_ITEM OI,SALES_CHECK SC,FFM_METHOD FFM, payment p,payment_instruction pi,pmt_method pm "
				...
				+ "and o.last_updated_ts > DATE_SUB(CURDATE(),INTERVAL 180 DAY) ORDER BY rand() limit 1";
		...
		try {
			...
			System.out.println("SQL Query:    ::"+Sql_LineItem_Return_Item_Eligible);
			st.execute();
			rs = st.getResultSet();
			while(rs.next()){
	...
	public static void giftCard_Information_OrderID() throws Exception{
		...
		Sql_Gift_Card_Info_Eligible = "select o.site_gen_ord_id,oi.item_id from ord o, ord_item oi, giftcard_order_item goi where o.order_id = oi.order_id "
				+ "and oi.order_item_id = goi.order_item_id and oi.item_nm like '%Gift Card%' "
				+ "and o.ORDER_STS_CD NOT in ('ABC','CSI','m','FRC','HLD','NCON','FDC','BAD','TEST','WFP','SHP','RET') "
				+ "and oi.order_item_sts_cd NOT in ('PCON','TEST','CAN','PRO') and o.site_gen_ord_id REGEXP '^-?[0-9]+$' "
				+ "and o.last_updated_ts > DATE_SUB(CURDATE(),INTERVAL 30 DAY) order by  rand() limit 1;";
	...
	public void vdc_line_item_cancellation_not_eligible() throws Exception{
